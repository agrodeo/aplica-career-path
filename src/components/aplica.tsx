  ...
  return <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur-sm">
    <div className={cn("mx-auto flex h-16 items-center justify-between px-5", product ? "max-w-[1200px]" : "max-w-[1120px]")}>
      ...
      {!simple && product && (
        <Link
          to="/profile"
          className="hidden h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-muted-foreground transition-colors hover:border-primary/30 hover:text-primary md:flex"
