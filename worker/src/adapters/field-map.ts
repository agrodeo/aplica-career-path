...
const PATTERNS: { key: CanonicalKey; patterns: RegExp[] }[] = [
  ...
  { key: "motivation", patterns: [/why (?:do )?you want to work/i, /why (?:are )?you interested/i, /why this (?:company|role)/i, /what interests you about/i, /por qu[eé] (?:te )?interesa/i] },
  { key: "about_you", patterns: [/tell us about yourself/i, /tell me about yourself/i, /about you/i, /contanos sobre vos/i, /cu[eé]ntanos sobre ti/i] },
  { key: "challenge_story", patterns: [/challenge you (?:faced|overcame)/i, /difficult problem/i, /problema dif[ií]cil/i, /desaf[ií]o que/i] },
  { key: "proud_achievement", patterns: [/achievement.*proud/i, /most proud/i, /logro.*orgull/i, /proyecto.*orgull/i] },
